...
const ElectronicTransferForm = ({ onSuccess, currentShift, currentStation }) => {
      ...
      <Card size="small">
        <Descriptions size="small" column={2}>
          ...
          <Descriptions.Item label="Station">
            {currentStation?.name || 'All Stations'}
          </Descriptions.Item>
        </Descriptions>
      </Card>
      ...
      >
        ...
        <Form.Item>
          <Button
            ...
            size="large"
            block
            disabled={!selectedDebtor || !selectedMethod || stationDebt === 0}
