...
const TanksStep = ({ stationId, closingData, onChange }) => {
  const { state } = useApp();
    ...
    return (
      <Alert variant="info" className="text-sm">
        <div className="flex items-start gap-2">
          ...
          <div>
            <p className="font-medium">Loading Tank Data</p>
            <p>Please wait while we fetch the latest tank readings...</p>
          </div>
        </div>
      </Alert>
    );
    ...
    return (
      <Alert variant="warning" className="text-sm">
        <div className="flex items-start gap-2">
          <Fuel className="w-4 h-4 mt-0.5 flex-shrink-0" />
          <div>
            <p className="font-medium">Error Loading Tank Data</p>
            <p>{error}</p>
          </div>
        </div>
      </Alert>
